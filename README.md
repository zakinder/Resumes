SAKINDERALI->[YEAR18->YEAR19->YEAR20->YEAR21]
1.TIME
1.1 TIME[DAY->NIGHT->DAY...FIND FOR NEXT]
1.1 TO DO DAY = NOTHING TO DO NEXT = FOR NEXT TO DO THAN CHECK DAY FOR NEXT DAY TO DO NEW TO DO NEXT NEW = INVENTION
1.1 [DAY->MONTH]->[MONTH->YEAR][SEC->MONTH][MONTH->YEAR]
2.RECALL
2.1 ANY HAPPY EVENT
2.2 ANY TIME RECALL
...
| Area                           | Description                                                                                                                                                                 |
| ------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🧪 **UVM Verification**        | Developed **SystemVerilog UVM testbenches** for high-speed digital subsystems. Focused on **modular, reusable components** compatible with legacy and new block structures. |
| 🧠 **DDR4 Memory Debug**       | Conducted deep signal debugging and waveform validation for **DDR4 memory interface** on defense-grade ASICs and FPGA platforms.                                            |
| 🔗 **SerDes & AXI Debug**      | Diagnosed and validated **high-speed serial transceivers (SerDes)** and **AXI interfaces** for internal bus communications.                                                 |
| 🔄 **Post-Silicon Bring-up**   | Used logic analyzers, oscilloscopes, and in-system debug IPs to bring up custom designs after fabrication.                                                                  |
| 📜 **Documentation**           | Authored internal guides, **testbench architecture summaries**, simulation reports, and bug resolution tracking.                                                            |
| 👥 **Cross-Team Coordination** | Collaborated across ASIC/FPGA teams, firmware validation, and system-level integration.                                                                                     |
...
| **2022–2023**  | Continued limited asynchronous engagement on design documents & toolchains (via cleared channel) |
| **01/04/2024** | Official end of employment with Northrop Grumman                                                 |

---

### 🧠 **Special Circumstance: "No Mercy" Year & Leave**
...
**Duration:** 05/13/2019 – 02/20/2020

### 🔧 TRANSEC Project Contributions:
...
**start to end (August 2016 – July 2017)** includes internal development, proposal authorship, hardware implementation, and government-level field training.
...
### 🔹 **AUGUST 2016 – INTERVIEW & TECHNICAL CHALLENGE PHASE**
...
### 🔹 **SEPT – OCT 2016 – SBIR PROPOSAL WRITING**

* Authored SBIR proposal titled:
  **“Network Isolation of Industrial Control System (ICS) Devices via Permanent Host Identifiers”**
...
### 🔹 **OCT – NOV 2016 – LAB SETUP & HARDWARE DEPLOYMENT**

* Relocated to College Station and set up residence at **2500 Central Park Ln Apt 1507**.
* Procured **LG 34” UltraWide Monitor (34UM65-P)** for embedded system lab.
* Tools used:
...
### 🔹 **NOV 2016 – JAN 2017 – QDR MEMORY CONTROLLER**
...
### 🔹 **JAN – JUN 2017 – CAMERA INTERFACE & TCP/IP STACK**
...
### 🔹 **JUNE 2017 – BORDER PATROL FIELD DEPLOYMENT**
...
## 🔧 Tools, Languages, Devices Used at Lynntech
...
## 🏭 **1. General Electric (GE Transportation) – Erie, PA**
...
## 🧪 **5. Howard Hughes Medical Institute – Ashburn, VA**

**Title:** Electrical Engineering Intern
**Duration:** 08/2011 – 11/2011
...
## 📡 **6. Axis Engineering Technologies – College Park, MD**
...
## 🌊 **7. Chesapeake Sciences Corporation (L3)** – Millersville, MD

**Title:** Electrical Engineer Co-op
**Duration:** 01/2008 – 08/2008
